...
| Container | `weewx-rtldavis-v2` · **prod runs `:v2.0.4`** (rollback: `:v2.0.3`) |
| Published image | **`:v2.0.5` + `:latest`** — one patch *ahead* of prod, deliberately (DEC-0038). Catch-up deploy owed. |
